...
public class Attack_Amethyst : Attack_Base {
    ...
    void Amethyst_Setup()
    {
        ...
        foreach (RaycastHit2D hit2 in Hits)
        {
            ...
            //perform a scan of all enemies within range and add them to the list. will be done again at the end.
